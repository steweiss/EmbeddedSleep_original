...
reticulate::use_python(reticulate::py_discover_config()[[1]],required = T)
library(reticulate)
# mainDir<-getwd()
...
loadpackage(c("plyr","dplyr","ggplot2","knitr","broom","ggfortify","hms","kableExtra","xts","eegUtils","dlm","forecast","signal","rmarkdown","plotly","visNetwork","Rssa","RHRV","data.table","DT","shinyTime","shinyWidgets","dygraphs","ggplotify","cowplot","tidyr"))
demoMode=F
print("here")
